...
export default function BarCustomersPage() {
  ...
  const { data: customers, isLoading: customersLoading } = useQuery(
    ['bar-customers', id, searchTerm],
    () => {
      if (searchTerm) {
        return api.get(`/bars/${id}/customers/search?q=${searchTerm}`).then(res => res.data || [])
      }
      return api.get(`/bars/${id}/customers`).then(res => res.data || [])
    }
  )
