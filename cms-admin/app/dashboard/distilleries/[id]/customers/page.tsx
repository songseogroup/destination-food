...
export default function DistilleryCustomersPage() {
  ...
  const { data: customers, isLoading: customersLoading } = useQuery(
    ['distillery-customers', id, searchTerm],
    () => {
      if (searchTerm) {
        return api.get(`/distilleries/${id}/customers/search?q=${searchTerm}`).then(res => res.data || [])
      }
      return api.get(`/distilleries/${id}/customers`).then(res => res.data || [])
    }
  )
