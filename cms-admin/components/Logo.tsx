...
/**
 * Destination Whisky logo (admin copy — kept in sync with project/components/Logo.tsx).
 *
 ...
 * works on the dark sidebar and on light surfaces.
 *
...
interface LogoProps {
  variant?: LogoVariant
  className?: string
  /** Renders as a plain element instead of a link to the dashboard. */
  asLink?: boolean
  href?: string
}
